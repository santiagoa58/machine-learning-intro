      ...
      <div className="mx-auto max-w-7xl py-8 sm:py-12 lg:py-16">
        ...
        <header className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-gray-700 dark:text-gray-400 max-w-2xl mx-auto">
            A comprehensive, hands-on introduction to machine learning that
            prioritizes understanding through application.
          </p>
        </header>

        {/* Philosophy */}
        <section
          className="bg-white dark:bg-gray-900 rounded-lg border border-gray-950/10 dark:border-white/10 p-6 sm:p-8 mb-8 sm:mb-12"
          aria-labelledby="philosophy-heading"
        >
          <h2
            id="philosophy-heading"
            className="text-2xl sm:text-3xl font-bold text-gray-950 dark:text-white mb-4"
          >
          ...
          <ol className="list-decimal list-inside space-y-3 text-base sm:text-lg text-gray-700 dark:text-gray-400 ml-2 sm:ml-4">
            <li>
              ...
              - Start with a real application and get results
            </li>
            <li>
              <strong className="text-gray-950 dark:text-white">
                Understand what it does
              </strong>{" "}
              - Explore the behavior and capabilities
            </li>
            <li>
              <strong className="text-gray-950 dark:text-white">
                Learn why it works
              </strong>{" "}
              - Dive into the theory with context and motivation
            </li>
            <li>
              <strong className="text-gray-950 dark:text-white">
                Master the details
        ...
        {/* Current Status */}
        <aside
          className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-400 p-4 sm:p-6 mb-8 sm:mb-12"
          role="note"
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12">
          {/* Supervised Learning */}
          <section
            className="bg-white dark:bg-gray-900 rounded-lg border border-gray-950/10 dark:border-white/10 p-6 sm:p-8"
            aria-labelledby="supervised-learning-heading"
          >
            <h2
              id="supervised-learning-heading"
              className="text-xl sm:text-2xl font-bold text-gray-950 dark:text-white mb-4"
            >
              Supervised Learning
            </h2>
            ...
            <ul className="space-y-2" role="list">
              {DOC_PAGES.map((page) => (
                <li key={page.slug}>
                  <Link
                    href={page.href}
                    className="inline-flex items-center min-h-11 py-2 text-blue-600 dark:text-blue-400 hover:underline font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded px-1"
                  >
                    → {page.title}
                  </Link>
                </li>
        ...
        >
          <h2
            id="features-heading"
            className="text-xl sm:text-2xl font-bold text-gray-950 dark:text-white mb-6"
          >
        ...
        >
          <p className="text-sm sm:text-base">
            Built with Next.js 16, React 19, Tailwind CSS v4, and a passion for
            effective learning
          </p>
          <p className="mt-2">
            <a
              href="https://github.com/santiagoa58/machine-learning-intro"
              className="inline-flex items-center min-h-11 text-blue-600 dark:text-blue-400 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded px-2"
              target="_blank"
