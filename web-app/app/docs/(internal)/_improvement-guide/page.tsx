...
export const metadata: Metadata = {
  ...
  description:
    "Practical templates and examples for implementing active learning principles in ML tutorials.",
  openGraph: {
  ...
  return (
    ...
    >
      <article className="prose prose-base sm:prose-lg dark:prose-invert max-w-none lg:max-w-4xl mx-auto py-8">
        ...
        <p>
          <strong>Quick Reference for Evidence-Based Enhancements</strong>
        </p>

        <p>
          This guide provides practical templates and strategies for
          transforming passive tutorials into active learning experiences. All
          recommendations are based on cognitive science research (see
          LEARNING_SCIENCE_REVIEW.md for full citations).
        </p>
        ...
        <p>
          <strong>Current State:</strong> Learners passively read and observe →
          Illusion of competence → Poor retention
        </p>
        <p>
          <strong>Goal State:</strong> Learners actively engage and retrieve →
          Deep understanding → Long-term mastery
        </p>

        <p>
          <strong>Research shows:</strong> Retrieval practice, metacognition,
          and worked examples are among the most powerful learning techniques.
        </p>
        ...
        <ul>
          <li>
            [ ] <strong>Before new concepts:</strong> Add learning objectives
            and pre-assessment
          </li>
          <li>
            [ ] <strong>During explanations:</strong> Insert prediction prompts
          </li>
          <li>
            [ ] <strong>After code examples:</strong>
            {` Add "Quick Check" retrieval questions`}
          </li>
          <li>
            [ ] <strong>For complex topics:</strong> Include completion problems
            (fill-in-the-blank)
          </li>
          <li>
            [ ] <strong>Address 3-5 common misconceptions explicitly</strong>
          </li>
          <li>
            [ ] <strong>End each major section:</strong> Reflection checkpoint
          </li>
          <li>
            [ ] <strong>End of tutorial:</strong> Comprehensive practice
            challenges
          </li>
        </ul>
        ...
        <pre>
          <code>{`### 📍 Before We Begin: [Topic Name]
...
- Rate your current understanding: 😰 Confused | 😐 Uncertain | 😊 Confident`}</code>
        </pre>
...
- What surprised you?
- What does this tell you about [concept]?`}</code>
        </pre>
...
**Reflection:**
- Were you close?
- If train R² >> test R², what does that suggest?`}</code>
        </pre>
        ...
        <pre>
          <code>{`### 🧠 Quick Check: Test Your Understanding
...
[Answer with example]
        ...
        <pre>
          <code>{`### 🧠 Quick Check: Train/Test Split
...
We'd have no independent data to evaluate with. Our performance metrics would be overoptimistic because we'd be testing on data the model has already seen.
        ...
        <pre>
          <code>{`### 🔨 Your Turn: Complete This Code
...
[Why this solution works]
        ...
        <pre>
          <code>{`### 🔨 Your Turn: Complete Gradient Descent
...
[Same structure as above]`}</code>
        ...
        <pre>
          <code>{`### ⚠️ Common Misconceptions About R²
...
**Continue to:** [Next tutorial]`}</code>
        </pre>
        ...
        <pre>
          <code>{`# Show complete solution with detailed comments
def complete_example():
    ...
    pass`}</code>
        ...
        <pre>
          <code>{`# Your Turn: Fill in the blanks
def completion_exercise():
    ...
    return result`}</code>
        ...
        <pre>
          <code>{`Similar problem with hints but no code scaffolding
Hints:
- [Hint 1]
- [Hint 2]`}</code>
        </pre>
        ...
        <pre>
          <code>{`Novel application - no hints, no scaffolding
Learner implements from scratch`}</code>
        </pre>
        ...
        <pre>
          <code>{`Complete all "Quick Check" questions and practice challenges`}</code>
        </pre>

        <h3>Day 1 Review (Next Day)</h3>
        <pre>
          <code>{`### 5-Minute Quick Quiz
...
[Transfer problems with novel datasets]`}</code>
        ...
        <ol>
          <li>
            ...
            {` - 3 "Quick Check" sections per tutorial (2-3 hours per tutorial)`}
          </li>
          <li>
            <strong>Misconceptions</strong> - Address 3-5 per tutorial (1-2
            hours per tutorial)
          </li>
          <li>
            <strong>End-of-tutorial challenges</strong> - Guided to independent
            progression (3-4 hours per tutorial)
          </li>
        </ol>
        ...
        <ol start={4}>
          <li>
            <strong>Learning objectives</strong> - Before each major section (1
            hour per tutorial)
          </li>
          <li>
            <strong>Reflection checkpoints</strong> - After complex sections (1
            hour per tutorial)
          </li>
          <li>
            <strong>Completion problems</strong> - After worked examples (2-3
            hours per tutorial)
          </li>
        </ol>
        ...
        <ol start={7}>
          <li>
            <strong>Prediction prompts</strong> - Before code outputs (1 hour
            per tutorial)
          </li>
          <li>
            <strong>Spaced retrieval schedule</strong> - Daily/weekly/monthly
            quizzes (8-10 hours total)
          </li>
          <li>
            <strong>Multiple contexts</strong> - 2-3 datasets per algorithm (5-6
            hours per tutorial)
          </li>
        </ol>
        ...
        <ol start={10}>
          <li>
            <strong>Pre-assessments</strong> - Personalized paths (5-6 hours)
          </li>
          <li>
            <strong>Growth mindset messaging</strong> - Normalize struggle (1
            hour per tutorial)
          </li>
          <li>
            <strong>CRA sequences</strong> - For especially complex topics (2-3
            hours per topic)
          </li>
        </ol>
        ...
        <ul>
          <li>
            <strong>Group A:</strong> Current passive format
          </li>
          <li>
            <strong>Group B:</strong> Enhanced with retrieval practice
          </li>
          <li>
            <strong>Measure:</strong> 1-week retention quiz performance
          </li>
        </ul>
        ...
        <p>
          <strong>Recommended Pilot:</strong> Linear Regression tutorial
        </p>
        ...
        <ol>
          <li>
            <strong>Day 1-2:</strong> Add retrieval practice (3 Quick Check
            sections)
          </li>
          <li>
            <strong>Day 3-4:</strong> Address misconceptions (5 Common Pitfalls
            boxes)
          </li>
          <li>
            <strong>Day 5-6:</strong> Add end-of-tutorial challenges (3
            progressive challenges)
          </li>
          <li>
            <strong>Day 7:</strong> Test with 5-10 learners, gather feedback
          </li>
        </ol>
        ...
        <ul>
          <li>
            <strong>Make It Stick</strong> by Brown, Roediger, & McDaniel - Most
            accessible introduction
          </li>
          <li>
            <strong>Small Teaching</strong> by Lang - Practical, evidence-based
            strategies
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>Retrieval Practice:</strong> Testing yourself strengthens
            memory more than re-reading
          </li>
          <li>
          ...
          <li>
            <strong>Interleaving:</strong> Mix different topics rather than
            blocking by topic
          </li>
          <li>
            <strong>Elaboration:</strong> Explain concepts in your own words
          </li>
          <li>
            <strong>Concrete Examples:</strong> Start with specific cases before
            general principles
          </li>
        </ul>
        ...
        <ol>
          <li>
            <strong>Cognitive Load Theory:</strong>
            {` Don't overwhelm working memory`}
          </li>
          <li>
            <strong>Dual Coding:</strong> Combine words and visuals
          </li>
          <li>
            <strong>Worked Examples:</strong> Show before asking
          </li>
          <li>
            <strong>Desirable Difficulties:</strong> Some struggle aids learning
          </li>
          <li>
            <strong>Metacognition:</strong> Think about your thinking
          </li>
        </ol>
        ...
        <ul>
          ...
          <li>
            [ ] Worked example progression (complete → completion → guided →
            independent)
          </li>
        ...
        <p>
          See <strong>LEARNING_SCIENCE_REVIEW.md</strong> for complete research
          citations and detailed analysis.
        </p>

        <p>
          <strong>Key Principle:</strong> Active engagement beats passive
          consumption. Make learners DO, not just READ.
        </p>

        <hr />

        <p>
          <strong>Last Updated:</strong> 2025-10-24
        </p>
        <p>
          <strong>See Also:</strong> LEARNING_SCIENCE_REVIEW.md,
