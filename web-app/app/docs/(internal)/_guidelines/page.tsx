...
export const metadata: Metadata = {
  ...
  description:
    "Teaching philosophy, content standards, and learning science principles for creating effective ML tutorials.",
  openGraph: {
  ...
  return (
    ...
    >
      <article className="prose prose-base sm:prose-lg dark:prose-invert max-w-none lg:max-w-4xl mx-auto py-8">
        ...
        <p>
          This document defines the teaching philosophy, content standards, and
          structural requirements for all materials in this machine learning
        ...
        <ol>
          <li>
            <a href="#core-teaching-philosophy">Core Teaching Philosophy</a>
          </li>
          <li>
            <a href="#learning-science-principles">
              Learning Science Principles
            </a>
          </li>
          <li>
            <a href="#content-structure-requirements">
              Content Structure Requirements
            </a>
          </li>
          <li>
            <a href="#writing-style-guidelines">Writing Style Guidelines</a>
          </li>
          <li>
            <a href="#technical-accuracy-standards">
          ...
          <li>
            <a href="#visual-and-interactive-elements">
        ...
        <ol>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                Motivate every theoretical concept by connecting it back to the
                application
              </li>
              <li>
        ...
        <p>
          <strong>Traditional approach:</strong> &quot;Here&apos;s 10 pages of math, now
        ...
        <p>
          <strong>Our approach:</strong> &quot;Here&apos;s what it does (cool!), now let&apos;s
        ...
        <p>
          These principles apply to ALL work in this project. They are listed in
          order of priority:
        </p>
        ...
        <ul>
          <li>
            <strong>Most important rule</strong>: If a learner doesn&apos;t
        ...
        <p>
          <strong>CRITICAL INSIGHT:</strong> Research in cognitive psychology
          shows that passive reading creates an &quot;illusion of
          competence&quot;—learners feel they understand while reading but struggle
          to apply knowledge independently. Our materials must engage learners
          in active cognitive processes that build durable, transferable
          understanding.
        </p>

        <p>
          This section incorporates evidence-based principles from learning
          science research. For complete research citations and detailed
          analysis, see <strong>LEARNING_SCIENCE_REVIEW.md</strong>.
        </p>

        <h3>Active Learning Over Passive Consumption</h3>

        <p>
          <strong>The Problem with Passive Learning:</strong>
        </p>
        <ul>
        ...
        <p>
          Every tutorial must include active engagement opportunities. Learners
          should:
        </p>
        <ul>
          <li>
            <strong>Retrieve</strong> information from memory (not just
            recognize it)
          </li>
          <li>
            <strong>Generate</strong> answers before seeing solutions
          </li>
          <li>
            <strong>Apply</strong> concepts to new situations
          </li>
          <li>
            <strong>Reflect</strong> on their understanding
          </li>
        </ul>
        ...
        <p>
          <strong>Research Finding:</strong> Testing yourself is more effective
          than re-reading for long-term retention (Roediger & Karpicke, 2006).
        </p>
        ...
        <ol>
          <li>
            ...
            <ul>
              ...
              <li>
                Use <code>&lt;details&gt;</code> tags to hide answers
              </li>
...
To evaluate performance on unseen data and detect overfitting
        ...
        <p>
          <strong>Why This Works:</strong> The act of retrieving information
          strengthens memory more than passive review. Even failed retrieval
          attempts improve subsequent learning.
        </p>

        <h4>Principle 2: Worked Examples with Faded Guidance</h4>

        <p>
          <strong>Research Finding:</strong> Learners acquire skills most
          effectively through a progression from complete examples to
          independent problem-solving (Sweller et al., 1998).
        </p>
        ...
        <ol>
          <li>
            <strong>Step 1: Fully worked example</strong> (current standard ✓)
            <ul>
          ...
          <li>
            <strong>Step 2: Completion problem</strong> (MUST ADD)
            <ul>
              <li>Same problem with 20-40% blanks to fill</li>
              <li>Provide hints</li>
              <li>
                Hide solution in <code>&lt;details&gt;</code> tag
              </li>
            </ul>
          </li>
          <li>
            <strong>Step 3: Guided problem</strong> (MUST ADD)
            <ul>
          ...
          <li>
            <strong>Step 4: Independent problem</strong> (MUST ADD)
            <ul>
        ...
        <pre>
          <code>{`### Worked Example: Linear Regression
...
Apply to your own dataset (no support)`}</code>
        </pre>

        <p>
          <strong>Why This Works:</strong> Gradually removing support prevents
          cognitive overload while building independent capability.
        </p>

        <h4>Principle 3: Metacognition - Think About Thinking</h4>

        <p>
          <strong>Research Finding:</strong> Learners who monitor and regulate
          their understanding achieve better outcomes (Schraw & Dennison, 1994).
        </p>
        ...
        <ol>
          <li>
            <strong>Learning objectives before complex sections</strong>
            <pre>
              <code>{`### 📍 Before We Begin: Gradient Descent

After this section, you should be able to:
- Explain why we need optimization
- Calculate one gradient descent step
- Identify when it might fail`}</code>
            </pre>
          </li>
          <li>
            <strong>Reflection checkpoints after complex sections</strong>
            <pre>
              <code>{`### 🤔 Reflection
...
If below 3, review the section`}</code>
            </pre>
          </li>
          <li>
            <strong>Self-assessment opportunities</strong>
            <ul>
        ...
        <p>
          <strong>Why This Works:</strong> Metacognitive awareness helps
          learners identify gaps, allocate study time effectively, and develop
        ...
        <p>
          <strong>Research Finding:</strong> Misconceptions persist unless
          directly confronted and replaced with correct understanding.
        </p>
...
- 🧠 **Check:** If R²=-0.5, what does that mean?
  ...
  Model performs worse than just predicting the mean
        ...
        <p>
          <strong>Why This Works:</strong> Merely presenting correct information
          doesn&apos;t erase misconceptions. They must be explicitly identified and
          refuted.
        </p>
        ...
        <p>
          <strong>Research Finding:</strong> Distributing practice over time
          with mixing of topics improves long-term retention by 20-30% (Cepeda
          et al., 2006).
        </p>
        ...
        <ol>
          <li>
            <strong>Within tutorials:</strong> Revisit concepts
            <ul>
          ...
          <li>
            <strong>Across tutorials:</strong> Interleave content
            <ul>
              <li>
                KNN tutorial should review train/test split from Linear
                Regression
              </li>
          ...
          <li>
            <strong>Spaced retrieval schedules:</strong>
            <pre>
              <code>{`### 🔄 Spaced Review
...
- 📅 Next month: Cumulative review`}</code>
            </pre>
          </li>
        </ol>

        <p>
          <strong>Why This Works:</strong> Spacing creates &quot;desirable
          difficulties&quot; that strengthen memory. Interleaving improves
          discrimination between concepts and transfer.
        </p>
...
Reflection:
- Were you close?
- What surprised you?`}</code>
        </pre>

        <p>
          <strong>Why This Works:</strong> Generating an answer (even wrong)
          before seeing the correct one improves learning more than passive
          reading.
        </p>
        ...
        <ol>
          <li>
            <strong>Concrete:</strong> Physical analogy or real-world example
          </li>
          <li>
            <strong>Representational:</strong> Visual diagram or animation
          </li>
          <li>
            <strong>Abstract:</strong> Mathematical formula or general principle
          </li>
        </ol>

        <p>
          <strong>Example: Gradient Descent</strong>
        </p>
        <ul>
          <li>Concrete: &quot;Blindfolded on a hill, feeling for downslope&quot;</li>
          <li>
            Representational: Animated visualization of ball rolling down
            surface
          </li>
          <li>
            Abstract: $m := m - \alpha \frac{"{"}∂J{"}"}
            {"{"}∂m{"}"}$
          </li>
        </ul>
...
4. Practical: One large error worse than two small ones
        ...
        <p>
          <strong>Working Memory Limitations:</strong>
        </p>
        <ul>
        ...
        <ol>
          <li>
            <strong>Chunk information meaningfully</strong>
            <ul>
          ...
          <li>
            <strong>Reduce extraneous load</strong>
            <ul>
          ...
          <li>
            <strong>Manage intrinsic load</strong>
            <ul>
          ...
          <li>
            <strong>Optimize germane load</strong>
            <ul>
        ...
        <p>
          <strong>Research Finding:</strong> Self-efficacy (belief in one&apos;s
          ability) predicts learning outcomes better than past achievement
          (Bandura).
        </p>
        ...
        <ol>
          <li>
            <strong>Normalize struggle</strong>
            <pre>
              <code>{`### 💪 Feeling Confused?

That's completely normal! Gradient descent is challenging.
Even ML experts found this hard at first.

Struggle is a sign your brain is growing.`}</code>
            </pre>
          </li>
          <li>
            <strong>Provide early wins</strong>
            <ul>
          ...
          <li>
            <strong>Growth mindset messaging</strong>
            <ul>
        ...
        <p>
          <strong>Spacing & Interleaving:</strong>
        </p>
        <ul>
        ...
        <p>
          <strong>Phase 1: Critical (Do First)</strong>
        </p>
        <ol>
        ...
        <p>
          <strong>Phase 2: High Value (Do Second)</strong>
        </p>
        <ol start={4}>
        ...
        <p>
          <strong>Phase 3: Enhancing (Do Third)</strong>
        </p>
        <ol start={7}>
        ...
        <p>
          <strong>Expected Improvements with Full Implementation:</strong>
        </p>
        <ul>
        ...
        <h2 id="content-structure-requirements">
          Content Structure Requirements
        </h2>
        ...
        <pre>
          <code>{`# [Algorithm Name]: From Application to Theory
...
- Links to related algorithms`}</code>
        </pre>
        ...
        <ul>
          <li>
            <strong>Section 1</strong>: Introduction
          </li>
          <li>
            <strong>Section 2</strong>: Application (practical, hands-on)
          </li>
          <li>
            <strong>Section 3</strong>: Theory (mathematical, conceptual)
          </li>
          <li>
            <strong>Section 4</strong>: Conclusion and next steps
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>Conversational but professional</strong>
            <ul>
          ...
          <li>
            <strong>Encouraging and inclusive</strong>
            <ul>
              <li>
          ...
          <li>
            <strong>Direct and active</strong>
            <ul>
        ...
        <ol>
          <li>
            <strong>What</strong> - Define it in plain language
          </li>
          <li>
            <strong>Why</strong> - Why do we need this? What problem does it
            solve?
          </li>
          <li>
            <strong>How</strong> - How does it work? What&apos;s the implementation?
          </li>
        </ol>
...
divides the data according to the ratio we specify.`}</code>
        </pre>
        ...
        <ul>
          <li>
            <strong>Always motivate before formulating</strong>
            <ul>
              <li>❌ &quot;The cost function is: J(θ) = ...&quot;</li>
              <li>
                ✅ &quot;We need a way to measure how wrong our predictions are. This
                measurement is called a cost function: J(θ) = ...&quot;
              </li>
            </ul>
          </li>
          <li>
            <strong>Explain every symbol</strong>
            <pre>
              <code>{`The equation is:
...
- $b$ is the y-intercept`}</code>
            </pre>
          </li>
          <li>
            <strong>Provide intuition alongside formulas</strong>
            <pre>
              <code>{`$$ MSE = \\frac{1}{n} \\sum_{i=1}^{n} (y_i - \\hat{y}_i)^2 $$

In plain English: we take each prediction error, square it (to make negatives positive
and to penalize large errors more), then average all these squared errors.`}</code>
            </pre>
          </li>
        </ul>
        ...
        <p>
          ❌ <strong>Don&apos;t assume knowledge</strong>
        </p>
        <ul>
          <li>Bad: &quot;Using standard gradient descent&quot;</li>
          <li>
            Good: &quot;Using gradient descent, an optimization algorithm that we&apos;ll
            explore in detail in Section 3.6&quot;
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            Good: &quot;Let&apos;s work through this step by step: First, we... Then we...
            Therefore...&quot;
          </li>
        </ul>

        <p>
          ❌ <strong>Don&apos;t use undefined acronyms</strong>
        </p>
        <ul>
        ...
        <p>
          ✅ <strong>Do provide context</strong>
        </p>
        <ul>
        ...
        <p>
          ✅ <strong>Do acknowledge complexity</strong>
        </p>
        <ul>
          <li>
          ...
          <li>
            &quot;If this seems confusing, that&apos;s normal - we&apos;ll clarify with an
            example&quot;
          </li>
        </ul>
        ...
        <ol>
          <li>
            ...
            <ul>
              ...
              <li>
                Example: &quot;The sigmoid function has domain (-∞, ∞) and range (0,
                1)&quot;
              </li>
            </ul>
          </li>
          <li>
            <strong>Asymptotic Behavior</strong>
            <ul>
              <li>Clarify when functions approach but never reach values</li>
              <li>
                Example: &quot;The sigmoid approaches 0 and 1 asymptotically but
                never actually reaches these values&quot;
              </li>
            </ul>
          </li>
          <li>
            <strong>Complexity Notation</strong>
            <ul>
              <li>Use Big-O notation correctly</li>
              <li>
                Specify what variables represent: &quot;O(N·d) where N is samples and
                d is dimensions&quot;
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              ...
              <li>
                Explain special cases: &quot;R² can be negative when the model
        ...
        <p>
          ❌ <strong>Imprecise range descriptions</strong>
        </p>
        <ul>
          <li>Bad: &quot;Sigmoid outputs values between 0 and 1&quot;</li>
          <li>
            Good: &quot;Sigmoid outputs values in the open interval (0, 1),
            approaching but never reaching 0 or 1&quot;
          </li>
        </ul>

        <p>
          ❌ <strong>Incorrect complexity</strong>
        </p>
        <ul>
          <li>Bad: &quot;KNN has O(N²) complexity&quot;</li>
          <li>
            Good: &quot;Brute-force KNN has O(N·d) complexity for a single
            prediction, where N is training samples and d is dimensions&quot;
          </li>
        </ul>

        <p>
          ❌ <strong>Ambiguous array indexing</strong>
        </p>
        <ul>
          <li>
            Bad: <code>cm[0][0] # True Negative</code>
          </li>
          <li>
            Good:{" "}
            <code>
              cm[0][0] # True Negative (assuming class 0 is negative - sklearn
              sorts labels)
            </code>
          </li>
        </ul>
        ...
        <ol>
          <li>
            ...
            <ul>
              <li>
                Always set <code>random_state</code> in stochastic operations
              </li>
              <li>
                Example:{" "}
                <code>
          ...
          <li>
            <strong>Correct Function Usage</strong>
            <ul>
        ...
        <ol>
          <li>
            ...
            <pre>
              <code>{`# ✅ GOOD - Clear variable names, commented
...
a, b, c, d = train_test_split(X, y, test_size=0.2)`}</code>
            </pre>
          </li>
          <li>
            ...
            <ul>
              ...
              <li>
                ✅ &quot;# Use log scale because feature values span many orders of
                magnitude&quot;
              </li>
        ...
        <ol>
          <li>
            <strong>Preceded by explanation</strong> - What we&apos;re about to do
            and why
          </li>
          <li>
            <strong>Followed by interpretation</strong> - What the output means
          </li>
        </ol>

        <p>Example:</p>
        <pre>
          <code>{`Now let's train our model on the training data. Training means the model will
...
remaining 20% that it hasn't seen before.`}</code>
        </pre>

        <hr />

        <h2 id="visual-and-interactive-elements">
          Visual and Interactive Elements
        </h2>
        ...
        <pre>
          <code>{`# ✅ GOOD - Complete labeling and context
...
plt.show()`}</code>
        ...
        <ul>
          ...
          <li>
            [ ] Code includes <code>random_state</code> where needed
          </li>
...
This is the cost function we minimize.`}</code>
        </pre>
...
the error would be -5, and the squared error would be 25.`}</code>
        </pre>
...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.2)`}</code>
        ...
        <pre>
          <code>{`Now that we have our features (X) and targets (y), we need to split them into
...
- \`X_test\` and \`y_test\`: 20% of the data for testing (model has never seen this)`}</code>
        </pre>
        ...
        <p>
          If you must choose between competing concerns, prioritize in this
          order:
        </p>

        <ol>
          <li>
            <strong>Correctness</strong> - Never sacrifice technical accuracy
          </li>
          <li>
            <strong>Clarity</strong> - If correct but unclear, simplify the
            explanation (not the accuracy)
          </li>
          <li>
            <strong>Completeness</strong> - Better to be thorough than brief
          </li>
          <li>
        ...
        <p>
          These guidelines exist to ensure every learner, regardless of
          background, can understand and apply machine learning concepts. When
          in doubt, ask:
        </p>
        ...
        <ul>
          ...
          <li>
            &quot;Am I showing them why this matters before diving into how it
            works?&quot;
          </li>
        ...
        <p>
          Remember:{" "}
          <strong>
            If the learner doesn&apos;t understand, we haven&apos;t taught effectively.
          </strong>
        </p>

        <p>
          The goal is not to impress with complexity, but to illuminate with
          clarity.
        </p>
      </article>
    </SidebarLayoutContent>
