import { Algorithm, DocPage, Feature, Module } from "./types";
...
export const DOC_PAGES: ReadonlyArray<DocPage> = [
  {
    ...
    description:
      "Learn how to get started with our comprehensive machine learning tutorial platform.",
    href: "/docs/readme",
  },
  {
    slug: "guidelines",
    ...
    description:
      "Teaching philosophy, content standards, and learning science principles.",
  ...
  },
  {
    ...
    description:
      "Expert analysis from cognitive psychology and learning science perspectives.",
  ...
  },
  {
    ...
    description:
      "Practical templates for implementing active learning principles.",
